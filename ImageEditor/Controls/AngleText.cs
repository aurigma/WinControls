    ...
    public class AngleText : System.Windows.Forms.UserControl
    {
        ...
        private void Panel1_MouseMove(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            if (blnMouseDown)
            {
                ...
                {
                    angle = Convert.ToInt32((System.Math.Atan(Convert.ToSingle(e.Y - 19) / Convert.ToSingle(e.X - 19)) / Math.PI) * 180.0F);
                    if (angle < 0)
                    {
                        angle = 360 + angle;
                    }
                ...
                {
                    angle = Convert.ToInt32((1.0F + System.Math.Atan(Convert.ToSingle(e.Y - 19) / Convert.ToSingle(e.X - 19)) / Math.PI) * 180.0F);
                }

                NumericUpDown1.Value = Convert.ToDecimal(angle % 360);
                Panel1.Refresh();
